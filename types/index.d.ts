...
declare function localStorage(): LocalStorage;
declare function sessionStorage(): SessionStorage;
declare function cookieStorage(): CookieStorage;

declare interface LocalStorage extends WebStorage {
  /**
...
declare interface SessionStorage extends WebStorage {
  /**
...
declare interface CookieStorage extends WebStorage {
  /**
